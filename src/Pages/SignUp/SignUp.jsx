...
const navigate = useNavigate()
  ...
  const { createUser, user, updatedProfile } = useAuth();

  const [passwordError, setPasswordError] = useState(null); //
  const [eye, setEye] = useState(false);
  const [ImageText, setImageText] = useState('Choose a file or drag');
  ...
  const handleForm = async data => {
    ...
    try {
      ...
      await AxiosSecure.put('/all-user', userData);
            ...
            <div>
              ...
              >
                  ...
                  <input
                    ...
                    className="mt-1 text-center font-medium tracking-wide text-gray-700  "
                    {...register('photo')}
                  />
