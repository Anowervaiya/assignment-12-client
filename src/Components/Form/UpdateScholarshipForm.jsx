    ...
    <div className="w-full border  min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl bg-gray-50">
      <div className="flex justify-center items-center gap-4 mb-16 mt-12">
        ...
        <h1 className="text-5xl font-semibold">
          {' '}
          Update <span className="text-orange-700 font-bold">A Scholarship</span>
        </h1>
      </div>
          ...
          <div className="space-y-6">
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                id="title"
                type="text"
                defaultValue={DetailsData?.ScholarshipName}
            ...
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                id="title"
                type="text"
                defaultValue={DetailsData?.UniversityName}
            ...
            <div className="flex justify-between gap-2">
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  id="price"
                  type="number"
                  defaultValue={DetailsData?.Universityrank}
              ...
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  id="guest"
                  type="number"
                  defaultValue={DetailsData?.TuitionFees}
            ...
            <div className="flex justify-between gap-2">
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  id="bedrooms"
                  type="number"
                  defaultValue={DetailsData?.ServiceCharge}
              ...
              <div className="space-y-1 text-sm">
                ...
                <input
                  ...
                  id="bathrooms"
                  type="number"
                  defaultValue={DetailsData?.ApplicationFees}
          ...
          <div className="space-y-6">
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                id="location"
                type="text"
                defaultValue={DetailsData?.location}
            ...
            <div className="space-y-1 text-sm">
              ...
              <select
                ...
                name="subject"
                defaultValue={DetailsData?.subject}
              >
            ...
            <div className="space-y-1 text-sm">
              ...
              <select
                required
                defaultValue={DetailsData?.ScholarshipCategory}
                className="w-full border px-4 py-3 border-orange-500 focus:outline-orange-500 rounded-md"
            ...
            <div className="space-y-1 text-sm">
              ...
              <select
                ...
                className="w-full border px-4 py-3 border-orange-500 focus:outline-orange-500 rounded-md"
                name="DegreeCategory"
                defaultValue={DetailsData?.DegreeCategory}
              >
            ...
            <div className="space-y-1">
              ...
              <div>
                <DatePicker
                  ...
                  selected={DetailsData?.ApplicationDeadline}
